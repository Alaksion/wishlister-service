...
export class CreateWishlistItemUseCase {
  ...
  async execute(
    ...
    // itemId is generated by the use case before repository insertion so that
    // both the staging upload and the persisted record can reference the same
    // final key shape: {userId}/{itemId}/{randomName}.
